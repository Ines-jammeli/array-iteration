...
//Q22
function EveneLengthWords(array){
    var result=lengths(array);
    var finalResult=[];
    var j=0;
...
return finalResult}
undefined
EveneLengthWords(['hi','cat','hello','ines'])
(2) ["hi", "ines"]
...
function pushLastElement(array,element){
    ...
    return array}
undefined
pushLastElement([ [1 ,2, 3, 4], [1, 2], [3, 4, 5]],1)
(3) [Array(5), Array(3), Array(4)]
0: (5) [1, 2, 3, 4, 1]
1: (3) [1, 2, 1]
2: (4) [3, 4, 5, 1]
length: 3
...
function multiplyBySmallest(array){
   return array.map(x => x * Math.min(...array))}
